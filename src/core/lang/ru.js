...
export default {
  ...
  RateThisApp: {
    ...
    titleBad: 'Нам очень жаль :(',
    text: 'Расскажите всем о своём опыте и оставьте отзыв!',
    textBad: 'С какими проблемами вы столкнулись?',
    rate: 'Да, классное!',
    no: 'Нет',
    later: 'Не сейчас',
  },
  ...
  PhoneChangeScreen: {
    ...
    isLoadingAddNewPhone: 'Обновляем ваш профиль...',
    comment:
    ...
    addNewComment: {
      addNewPhone:
        'Введите ваш телефон.\r\n\r\nНа него будет отправлено СМС-сообщение с кодом.',
      addNewEmail:
        'Введите ваш Email.\r\n\r\nНа него будет отправлено письмо с кодом.',
    },
    enterCode: 'Код',
  },
  Form: {
    group: {
      ...
      contacts2: 'Как мы можем к вам обращаться?',
      email: 'Email',
      emailFeedback: 'Как мы можем с вами связаться?',
      phones: 'Телефоны',
      foto: 'Фотографии',
      additional: 'Дополнительно',
      textFeedback: 'Поделитесь, пожалуйста, Вашим опытом',
