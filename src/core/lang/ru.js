  ...
  ProfileScreenInfo: {
    ...
    bonus: {
      ...
      current: {
        ...
        text2: 'баллов', // 0
        text3:
          'Узнайте больше о бонусной программе и накапливай баллы быстрее!',
  ...
  ServiceScreenStep1: {
    Notifications: {
      error: {
        ...
        wrongDealer: 'Пожалуйста, убедитесь, что в вашем кабинете выбран автоцентр с профильной маркой.',
        noData: 'Калькулятор ТО недоступен сейчас для этого автомобиля.\r\nВозможно данные ещё не готовы, или вы указали неверный автоцентр.',
        noDataCar: 'Калькулятор ТО недоступен сейчас для этого автомобиля.\r\nМы работаем над тем, чтобы исправить ситуацию.',
      },
      loading: {
