export default {
  ...
  Notifications: {
    ...
    UpdatePopup: {
      ...
      text: 'Пожалуйста, обнови приложение до актуальной версии.',
      update: 'Обновить',
      later: 'Позже',
    },
  },
  ...
  ReviewAddMessageForm: {
    ...
    placeholder: {
      plus: 'Что тебе понравилось в работе автоцентра? Кому бы ты хотел выразить благодарность?',
      minus: 'Чем ты остался недоволен в работе автоцентра?',
    },
  },
  ...
  ReestablishScreen: {
    ...
    notFound: {
      text: 'Мы очень раздасадованы тем, что ты не обнаружил свои автомобили и бонусный счет в личном кабинете.',
    ...
    Notifications: {
      error: {
        emailPhone: {
          ...
          text: 'Пожалуйста укажи хотя бы один контакт для возможности связи с тобой',
        },
      },
    },
    save: 'Сохранить',
  ...
  SettingsScreen: {
    ...
    pushText: 'Будь в курсе новых акций и предложений',
    pushText2: '\r\nМы не будем беспокоить тебя по пустякам.\r\nОбещаем!',
