export default {
  ...
  Form: {
    ...
    agreement: {
      ...
      first: 'Я подтверждаю ознакомление с',
      second: 'Политикой обработки персональных данных',
      third:
        'и выражаю согласие на обработку моих персональных данных в соответствии с Условиями обработки персональных данных',
    },
  },
  Base: {
    or: 'или',
