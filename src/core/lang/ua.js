export default {
  Menu: {
    main: {
      ...
      bonus: 'Бонусна програма Автодім Атлант',
    },
    bottom: {
      // нижнее меню
      search: 'Авто',
  ...
  Notifications: {
    ...
    PushAlert: {
      title: 'Повідомлення вимкнено!',
      text: 'Необхідно дозволити отримання push-повідомлень для Автодім Атлант у налаштуваннях',
      later: 'Пізніше',
      approve: 'Дозволити',
    },
  },
  ...
  ProfileSettingsScreen: {
    ...
    Notifications: {
      ...
      deleteAccount: {
        title: 'Ви впевнені?',
        text: 'Ваш обліковий запис буде незворотно видалено з усією інформацією.\r\n\r\nВідновити видалені дані неможливо.',
      },
    },
    save: 'Зберегти',
  ...
  ProfileScreenInfo: {
    ...
    additionalPurchase: {
      title: 'Мої покупки',
      text: 'Історія ваших покупок в Автодім Атлант',
    },
  ...
  ServiceScreenStep1: {
    Notifications: {
      error: {
        ...
        wrongDealer:
          'Будь ласка, переконайтеся, що у вашому кабінеті обрано автоцентр із профільною маркою.',
        noData:
          'Калькулятор ТО недоступний для цього автомобіля.\r\nМожливо, дані ще не готові, або ви вказали невірний автоцентр.',
        noDataCar:
          'Калькулятор ТО недоступний для цього автомобіля.\r\nМи працюємо над тим, щоби виправити ситуацію.',
      },
      loading: {
  ...
  PhoneChangeScreen: {
    title: 'Залишилося\r\nзовсім трішки',
    isLoading: 'Входимо в особистий кабінет...',
    comment:
  ...
  Form: {
    ...
    agreement: {
      ...
      first: 'Натискаючи на кнопку, я приймаю умови',
      second: 'угоди користувача',
      third: 'і висловлюю згоду на обробку персональних даних',
    },
  },
  Base: {
    or: 'чи',
