...
export const INFO_LIST__REQUEST_DEALER = 'INFO_LIST__REQUEST_DEALER';
export const INFO_LIST__SUCCESS = 'INFO_LIST__SUCCESS';
export const INFO_LIST__SUCCESS_DEALER = 'INFO_LIST__SUCCESS_DEALER';
export const INFO_LIST__FAIL = 'INFO_LIST__FAIL';
export const INFO_LIST__FAIL_DEALER = 'INFO_LIST__FAIL_DEALER';
export const INFO_LIST__RESET = 'INFO_LIST__RESET';
export const INFO_LIST__RESET_DEALER = 'INFO_LIST__RESET_DEALER';
