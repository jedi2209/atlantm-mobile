    ...
    return (
      <Container style={styles.container}>
        <View style={styles.logoContainer}>
          ...
          <Modal isVisible={true} backdropOpacity={0.4} swipeDirection="left">
            <View style={styles.modal}>
              ...
              <Text style={{fontFamily: styleConst.font.regular, fontSize: 12}}>
                ...
                {'\n'}К сожалению, Apple не позволяет провести настолько
                глобальное обновление в рамках текущего приложения :({'\n'}
                Поэтому мы вынуждены просить Вас удалить текущее приложение и
                скачать новое.{'\n'}
                {'\n'}Спасибо!
              </Text>
              <Button
                ...
                onPress={() => {
                  Linking.openURL(
                    'itms-apps://apps.apple.com/app/apple-store/idXXXX',
                  );
                }}>
